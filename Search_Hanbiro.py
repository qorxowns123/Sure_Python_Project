...
LOGIN_INFO = { 'hmil_id': 'tjback123', 'hmil_pass': '' }
...
with requests.Session() as s:
    ...
    #print(login_req.status_code) # 200인 경우 로그인 성공
    if login_req.status_code != 200:
        raise Exception('로그인이 되지 않았습니다. 아이디와 비밀번호를 다시한번 확인해주세요') # raise는 에러를 직접 만든다.
